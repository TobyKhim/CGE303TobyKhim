...
//require Rigidbody2D and an Animator on the enemy
...
public class EnemyMoveWalkingChase : MonoBehaviour
{
    ...
    void Update()
    {
        //this vector is a 2D arrow from the enemy to the player
        Vector2 playerDirection = playerTransform.position - transform.position;

        //Distance between the enemy and the player
        //magnitude of the vector is the disance without the direction
        ...
        if (distanceToPlayer <= chaseRange)
        {
            ...
            //rotate the enemy to the player face
